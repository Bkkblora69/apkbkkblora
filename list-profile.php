...
if(isset($_POST['submit'])):
	...
	if(empty($errors)):
		$update = mysqli_query($koneksi,"UPDATE user SET nama = '$nama', nomor_telepon = '$nomor_telepon' WHERE id_user = '$id_user'");
		
		if($password) {
			$pass = sha1($password);
			$update = mysqli_query($koneksi,"UPDATE user SET nama = '$nama',  password = '$pass', nomor_telepon = '$nomor_telepon' WHERE id_user = '$id_user'");
		}		
		if($update) {
