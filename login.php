...
<head>
    ...
    <title>HELPDESK  BKK BLORA</title>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-justify card-body p-0">
                        <!-- <img src="assets/img/Saw.jpg" style="width:100%;"> -->
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login.php" method="post">
                                        ...
                                        <!-- <a href="daftar.php" class="btn btn-primary btn-user btn-block"><i class="fas fa-fw fa-sign-in-alt mr-1"></i> Daftar </a> -->
                                    </form>
                                </div>
                            </div>
                        </div>
